...
from Xray.entity.config_entiity import DataTransformationConfig
...
class DataTransformation:
    ...
    def transforming_training_data(self) -> transforms.Compose:
        try:
            logging.info(
                "Entered the transforming_training_data "
                "method of Data transformation class"
            )
            ...
            logging.info(
                "Exited the transforming_training_data "
                "method of Data transformation class"
            )
    ...
    def transforming_testing_data(self) -> transforms.Compose:
        ...
        try:
            ...
            logging.info(
                "Exited the transforming_testing_data "
                "method of Data transformation class"
            )
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            logging.info(
                "Entered the initiate_data_transformation "
                "method of Data transformation class"
            )
            ...
            logging.info(
                "Exited the initiate_data_transformation "
                "method of Data transformation class"
            )
